...
# Install packages
yay -S hyprland xdg-desktop-portal xdg-desktop-portal-hyprland kio-admin playerctl rofi fish starship wget nwg-look-bin kitty kbd micro hyprshot waybar dunst ttf-font-awesome ttf-jetbrains-mono-nerd fuzzel wlogout copyq btop nvtop python python-pyqt5 ffmpeg linux-wallpaperengine-git waypaper-git swww polkit-kde-agent qt5ct kvantum layan-gtk-theme-git kora-icon-theme --noconfirm
