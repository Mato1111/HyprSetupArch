...
# Install packages
yay -S hyprland-git xdg-desktop-portal xdg-desktop-portal-hyprland fish starship wget kitty kbd micro waybar dunst ttf-font-awesome ttf-jetbrains-mono-nerd fuzzel wlogout copyq btop nvtop python python-pyqt5 ffmpeg linux-wallpaperengine-git waypaper swaybg polkit-kde-agent qt5ct kvantum layan-gtk-theme-git kora-icon-theme --noconfirm
