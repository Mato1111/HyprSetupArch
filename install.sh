...
# Install packages
yay -S hyprland-git xdg-desktop-portal xdg-desktop-portal-hyprland-git wget kitty waybar-hyprland dunst fuzzel copyq btop nvtop python python-pyqt5 ffmpeg linux-wallpaperengine-git waypaper swaybg polkit-kde-agent qt5ct kvantum layan-gtk-theme-git kora-icon-theme --noconfirm
